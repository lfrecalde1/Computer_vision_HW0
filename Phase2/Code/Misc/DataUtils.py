...
def SetupAllTest(BasePath, CheckPointPath):
    """
    Inputs:
    BasePath is the base path where Images are saved without "/" at the end
    CheckPointPath - Path to save checkpoints/model
    ...
    """
    # Setup DirNames
    DirNamesTrain = SetupDirNamesTest(BasePath)

    # Read and Setup Labels
    LabelsPathTrain = "./TxtFiles/LabelsTest.txt"
    TrainLabels = ReadLabels(LabelsPathTrain)
...
def SetupDirNamesTest(BasePath):
    """
    Inputs:
    BasePath is the base path where Images are saved without "/" at the end
    Outputs:
    Writes a file ./TxtFiles/DirNames.txt with full path to all image files without extension
    """
    DirNamesTrain = ReadDirNames("./TxtFiles/DirNamesTest.txt")
